...
//    set_intersection(it11, it12, it21, it22, back_inserter(intersection_set));
//
//    vector<string> union_set;
//    set_union(it11, it12, it21, it22, back_inserter(union_set));
...
//  for (auto &l: lines) {
//    sort(l.begin(), l.end(), std::less<string>());
//  }
}
...
void SimJoiner::sortWordsByIDF(std::vector<std::string> &words, const std::map<std::string, int> &dict) {
  sort(words.begin(), words.end(),
       [&dict](const string &lhs, const string &rhs) -> bool {
